...
void Reset_Handler(void)
{
  ...
  //symbols are names given to the address location we do NOT want the value at _edata
  //We want the address value of edata that is where the data section ends
